      ...
      <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <PricingCard
          ...
          features={[
            ...
            "Revision mode for focused studying",
          "Priority support"
          ]}
          selectedPrice={selectedPrice}
          setSelectedPrice={setSelectedPrice}
        ...
        <PricingCard
          ...
          amount={500}
          credits="300"
          description="Ideal for serious learners and exam warriors"
          features={[
            "Maximum credits for extensive notes",
            "Unlimited diagram & chart generation",
            "Revision mode with enhanced focus",
          "Ideal for multiple subjects and exams",
          ]}
          selectedPrice={selectedPrice}
          setSelectedPrice={setSelectedPrice}
          onBuy={handleBuyCredits}
